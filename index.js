...
fetch("/status.php").then(res => res.json()).then(processEggStatus);
fetch("https://raw.githubusercontent.com/kolmafia/kolmafia/main/src/data/monsters.txt").then(res => res.text()).then(processMonsters);
...
function selectTab(tab) {
    ...
    result.monster_list.sort(function(x, y) {
        if (tab == "id") return cmp(x.id, y.id);
        if (tab == "name") {
